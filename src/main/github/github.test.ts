...
import { extractPrNumber, extractRepoFromPrUrl, parseRemoteUrl, findUnresolvedThreads, formatCommentsForPrompt } from './client'
...
describe('parseRemoteUrl', () => {
  ...
  it('throws for unsupported URL formats', () => {
    expect(() => parseRemoteUrl('https://gitlab.com/foo/bar')).toThrow(
