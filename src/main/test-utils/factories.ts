...
import type { ReviewComment, PullRequest } from '../github/client'
import type { WorkItem, WorkItemFields, AzureConfig } from '../azure/client'
 ...
 */
export function makeTaskInState(
  state: GridState,
